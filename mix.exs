defmodule Lovebomb.MixProject do
  use Mix.Project
  ...
  defp aliases do
    [
      ...
      "assets.build": ["tailwind lovebomb", "esbuild lovebomb"],
      "assets.deploy": [
        "tailwind lovebomb --minify",
        "esbuild lovebomb --minify",
        "phx.digest"
      ]
    ]
  end
